...
public class MathAlarmTaskGenerator {
    ...
    private int result,number1,number2,number3;
    ...
    private int GenerateRandomMathSymbol(int complexityLevel){
        ...
        //for  easy complexity only 2 sign
        randomCharacterEasy[0] = random.nextInt(5 - 1) + 1;
        //for  medium complexity 4 sign
    ...
    private int CountResultOfEquation(int number1, int number2, int symbol){
        switch (symbol) {
            ...
            default:
                if(ShowLogs.LOG_STATUS) ShowLogs.i("CountResultOfEquation error symbol is " + symbol);
                break;
        }
        return 0;
    }
    ...
    int symbol1,symbol2;
        switch (complexity){
            ...
            default:
                if(ShowLogs.LOG_STATUS) ShowLogs.i("GeneratorEquation error complexity > 4");
            break;
        }
    }
